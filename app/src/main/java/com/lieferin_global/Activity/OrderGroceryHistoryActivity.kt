...
import com.lieferin_global.Fragment.NewGroceryOrderFragment
import com.lieferin_global.Fragment.PastOrderGroceryFragment
...
class OrderGroceryHistoryActivity : Fragment(),View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        adapter!!.addFragment(NewGroceryOrderFragment(), getString(R.string.Orders_New))

        adapter!!.addFragment(PastOrderGroceryFragment(), getString(R.string.Orders_Old))
