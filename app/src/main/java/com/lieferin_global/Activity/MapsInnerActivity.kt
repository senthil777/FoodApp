...
import com.lieferin_global.Fragment.UpdateProfileFragment
...
class MapsInnerActivity : AppCompatActivity(), OnMapReadyCallback,  View.OnClickListener,
    ResponseListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(Constant.AppType!!.equals("0")) {
            ...
            changeText!!.setTextColor(Color.parseColor("#ec272b"))

            continueTxt!!.setBackgroundResource(R.drawable.home_radius_button_orange)

        }else {
            changeText!!.setTextColor(Color.parseColor("#7DC77D"))
        ...
        when(view!!.id)
        {
            ...
            R.id.changeText->{
                //startActivity(Intent(this,AddressSearch::class.java))
                    ...
                    var intent = Intent(this, AddressSearch::class.java)
            ...
            R.id.continueTxt -> {
                ...
                }else if(AppUpdate!!.equals("1")){
                    var intent = Intent(this, UpdateProfileFragment::class.java)
...
*/
    ...
    override fun onCameraIdle() {
        ...
        //addressSubDescriptionTV!!.text =addresses[0].getAddressLine(0);
                ...
                locationAddressTV!!.text = getCompleteAddressString(this@MapsInnerActivity,center.latitude,center.longitude)
