...
import com.lieferin_global.Fragment.NewOrderFragment
import com.lieferin_global.Fragment.PastOrderFragment
...
class OrderHistoryActivity : Fragment(),View.OnClickListener {

    var orders_back: ImageView? = null

    var orders_Title: TextView? = null

    var tabOrderHistory : TabLayout? = null

    var viewpagerOrderHistory : ViewPager? = null
    ...
    override fun onCreateView(
        ...
        rootView = inflater.inflate(R.layout.activity_order_history, container, false)
        ...
        viewpagerOrderHistory = rootView!!.findViewById(R.id.viewpagerOrderHistory) as ViewPager
        ...
        adapter!!.addFragment(NewOrderFragment(), getString(R.string.Orders_New))

        adapter!!.addFragment(PastOrderFragment(), getString(R.string.Orders_Old))

        viewpagerOrderHistory!!.setAdapter(adapter)

        tabOrderHistory = rootView!!.findViewById(R.id.tabOrderHistory) as TabLayout
        tabOrderHistory!!.setupWithViewPager(viewpagerOrderHistory);

        val betweenSpace = 25

        val slidingTabStrip = tabOrderHistory!!.getChildAt(0) as ViewGroup
