...
class OtpVerificationActivity : Activity(),View.OnClickListener,ResponseListener {
    ...
    override fun onClick(view: View?) {
        ...
        when(view!!.id)
        {
            ...
            R.id.verify_enter_otpBT ->
            {
                ...
                obj.put("otpToken", txt_pin_entry!!.text)
                Log.v("Json", "Value" + obj)
                RequestManager.setVerifyCustomerOTP(this, obj, this);
    ...
    override fun onResponseReceived(responseObj: Any?, requestType: Int) {
        ...
        if(responseObj != null)
        {
            if(requestType == Constant.MEMBER_getVerifyCustomerOTP_URL_RQ)
            {
                showToast(this,(responseObj as BaseRS).message)

                if((responseObj as BaseRS).status.equals("1014")) {
            ...
            }else if(requestType == Constant.MEMBER_getCustomerForgot_URL_RQ)
            {
                showToast(this,(responseObj as BaseRS).message)
                ...
                if((responseObj as BaseRS).status.equals("1012")) {
                    ...
                    //txt_pin_entry!!.setText((responseObj as BaseRS).otp)
    ...
    fun successDialog(context: Context, msgText:String)
    {
        ...
        textSuccess!!.text = "Otp has been send to your email Id & mobile number"
