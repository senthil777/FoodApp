...
class FilterInnerPage : AppCompatActivity(),FiltersidePageAdapter.CallbackDataAdapter,View.OnClickListener,FilterPricePageAdapter.CallbackDataAdapter {
...
/*
    ...
    override fun setOnFilterSide(id: String?) {
        ...
        if(id!!.equals("Category")){
            val bundle = Bundle()
            bundle.putString("restaurantReferenceCode", ""+restrauntReference)
            val activityFragment: Fragment = CategoryFragment()
