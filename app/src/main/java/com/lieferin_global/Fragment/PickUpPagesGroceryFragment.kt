...
class PickUpPagesGroceryFragment : Fragment(),ViewAllDishAdapter.CallbackDataAdapter,ResponseListener {
            ...
            if (requestType == Constant.MEMBER_userGroceryDashboard_URL_RQ) {
                if((responseObj as BaseRS).status.equals("5801")) {
                    ...
                    for (i in 0 until (responseObj as BaseRS).fetchData!!.groceryListing!!.size) {
                        ...
                        if (!(responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).deliveryCollectionStatus!!.equals(
                                "2"
                            )
                        ) {
                            adapterModel = AdapterModel(
                                ...
                                "" + (responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).street,
                                (responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).distance + " KM - " + (responseObj as BaseRS).fetchData!!.groceryListing!!.get(
                                    i
                                ).town,
                                "Open now",
                                "€ "+""+(responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).minimumOrderAmount+" for Minimum Order",
                                ...
                                "1",
                                "" + (responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).groceryReferenceCode,
                                "" + (responseObj as BaseRS).groceryPath+""+(responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).folderName,
                                ""+ getImageValue1((responseObj as BaseRS).fetchData!!.groceryListing!!.get(i).groceryImages),
                                "",
                                "",
                                0,
                                0,
