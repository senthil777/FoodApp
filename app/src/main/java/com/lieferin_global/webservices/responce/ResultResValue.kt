...
class ResultResValue() : BaseRS(), Serializable,Parcelable {
    var id: String? = null
    ...
    var itemsPackingTime : String? = null
    ...
    var groceryOrderReferenceCode : String? = null
    ...
    var actualBookingAmount : String? =null
    ...
    var customerIncludeStatus : String? = null

    var itemList : MutableList<WorkExperience>? = null
    ...
    var toppinsGroupJsonData: WorkExperience? = null
    ...
    companion object CREATOR : Parcelable.Creator<ResultResValue> {
        override fun createFromParcel(parcel: Parcel): ResultResValue {
            return ResultResValue(parcel)
        }

        override fun newArray(size: Int): Array<ResultResValue?> {
