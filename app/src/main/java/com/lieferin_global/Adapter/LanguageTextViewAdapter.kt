...
class LanguageTextViewAdapter(context: Context, adapterModels: List<AdapterModel>, val dialog: Dialog, val textView: TextView) :
    RecyclerView.Adapter<LanguageTextViewAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
       ...
       holder.textValue.text = adapterModels.get(position).categoryName
        ...
        holder.textValue.setOnClickListener(View.OnClickListener { mCallback!!.setOnDetail(adapterModels.get(position).categoryName,adapterModels.get(position).price,textView)
    ...
    interface CallbackDataAdapter {
        ...
        fun setOnDetail(id: String?,position:String?,textView: TextView)
