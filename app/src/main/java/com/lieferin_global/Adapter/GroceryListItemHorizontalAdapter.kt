...
class GroceryListItemHorizontalAdapter(context: Context, private val adapterModels: List<AdapterModel>) : RecyclerView.Adapter<GroceryListItemHorizontalAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Picasso.with(context).load(adapterModels.get(position).offer).resize(450,450).into(holder.productImg)
