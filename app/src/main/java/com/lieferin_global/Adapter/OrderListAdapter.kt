...
import com.lieferin_global.Utility.customText
import com.lieferin_global.Utility.fontStyle

class OrderListAdapter(context: Context, adapterModels: List<Product>) : RecyclerView.Adapter<OrderListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemDescription.setText(customText(context,adapterModels[position].menuReferenceCode,20,"SemiBold","Light"))
        ...
        holder.viewOrder.setOnClickListener(View.OnClickListener { mCallback!!.setOnMaterial("View Order",adapterModels[position]) })
        ...
        if(adapterModels[position].bookingCode.equals("6"))
        {
            if(AppType!!.equals("0")) {
                holder.trackOrder.text = "Rate Meal"
            }else{
                holder.trackOrder.text = "Rate Product"
            }
        }else if(adapterModels[position].bookingCode.equals("7"))
        {

        holder.trackOrder.text = "Cancel"

        }else{
            holder.trackOrder.text = "Track"
        }
