...
class GroceryListItemHorizontal1Adapter(context: Context, private val adapterModels: List<AdapterModel>) : RecyclerView.Adapter<GroceryListItemHorizontal1Adapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        Log.v("Img"+adapterModels.get(position).offer,"LL")

        if(!adapterModels.get(position).offer.equals("")) {

            Picasso.with(context).load(adapterModels.get(position).offer).resize(450, 450).placeholder(R.drawable.item_placeholder_geocery)
        ...
        holder.addImage.setOnClickListener(View.OnClickListener {
            ...
            mCallback!!.setOnExtraItem1("",""+position)
        ...
        holder.productRelative.setOnClickListener(View.OnClickListener {mCallback!!.setOnProduct(""+adapterModels.get(position).categoryReferenceCode,adapterModels.get(position).parlourRatingCount+"-"+adapterModels.get(position).parlourGivenRating)  })
    ...
    interface CallbackDataAdapter {
        fun setOnExtraItem1(type: String?, id: String?)
