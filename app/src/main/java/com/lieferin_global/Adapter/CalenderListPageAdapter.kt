...
class CalenderListPageAdapter(context: Context, private val adapterModels: List<AdapterModel>) : RecyclerView.Adapter<CalenderListPageAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.calender_view_layout, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (position == selectedPosition) {
            holder.calenderView.setBackgroundResource(R.drawable.backgound_light_corner)
            ...
            holder.calenderView.setBackgroundResource(R.drawable.home_cal_black_corner)
