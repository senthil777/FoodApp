...
class LanguageAdapter(context: Context, adapterModels: List<AdapterModel>, val dialog: Dialog) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
       ...
       holder.textValue.text = adapterModels.get(position).categoryName
        ...
        holder.textValue.setOnClickListener(View.OnClickListener { mCallback!!.setOnDetail(adapterModels.get(position).categoryName,adapterModels.get(position).price,adapterModels.get(position).offerPrice!!)
