...
class TestStackAdapter(context: Context?) :
    ...
    internal class ColorItemViewHolder(view: View) :
    ...
    internal class ColorItemLargeHeaderViewHolder(view: View) :
        ...
        override fun onAnimationStateChange(
            state: Int,
            willBeSelect: Boolean
        ) {
        ...
        fun onBind(data: Int?, position: Int) {
            ...
            itemView.findViewById<View>(R.id.text_view)
                .setOnClickListener { (itemView.parent as CardStackView).performItemClick(this@ColorItemLargeHeaderViewHolder) }
        }
